%%% This file estimates the results reported in Tables E2 & E3, 4-VAR
...
load Data                                    % Sample period: 1982.01 - 2022.09
...
%%% MSPEs 
    for ihor = 1:nfore
        if irep<=t-ihor
            %store the forecast in level form of oil price for each model
            %only for one step-forecast
            fore_m = zeros(ndraws,nmodel);
            
            %bring the log oil price to the original form in level
