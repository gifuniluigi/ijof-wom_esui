function [y_fore] = fore_VAR(YF,intercept,beta_t,Q_t,r,nlag,nfore,ndraws,gamma,X1)
X_fore = [];
for i = 1:nlag
...
for ihor = 1:nfore
    ...
    if ndraws == 1
        ...
        y_fore(:,ihor,:) = repmat(VAR_FORECAST(1:r)+X(:,end),1,ndraws) +  chol(VAR_var(1:r,1:r))'*randn(r,ndraws);
    end
    BB = BB*By;
end
