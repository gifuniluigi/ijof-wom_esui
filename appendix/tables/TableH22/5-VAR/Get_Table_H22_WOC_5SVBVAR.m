%%% This file estimates the results reported in Table H22, 5-SVBVAR
...
clear y_fore;
modname = '5SVBVAR1'; % add 1 (e.g., 5SVBVAR1) if results are obtained using Ucount;
                      % add 2 (e.g., 5SVBVAR2) if results are obtained using Boolean
                      % and so on...
