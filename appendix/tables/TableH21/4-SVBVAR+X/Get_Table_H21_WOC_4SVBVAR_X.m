%%% This file estimates the results reported in Table H21, 4-SVBVARX
...
load DataC                                   % Sample period: 1982.01 - 2021.06
...
YY=[WOC WIP oecd_inv];   % Fixed Matrix
...
clear y_fore;
modname = '4SVBVAR_X1'; % add _X1 (e.g., 4SVBVAR_X1) if results are obtained using Scount;
                        % add _X2 (e.g., 4SVBVAR_X2) if results are obtained using Dictionary: Financial Stability (Correa et al.[2017])
                        % and so on...
