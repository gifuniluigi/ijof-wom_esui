%%% This file estimates the results reported in Table H21, 5-SVBVAR
...
clear y_fore;
modname = '5SVBVAR1'; % add 1 (e.g., 5SVBVAR1) if results are obtained using Scount;
                      % add 2 (e.g., 5SVBVAR2) if results are obtained using Dictionary: Financial Stability (Correa et al.[2017])
                      % and so on...
