...
clear y_fore;
modname = '5BVAR1'; % add 1 (e.g., 5BVAR1) if results are obtained using Scount;
                    % add 2 (e.g., 5BVAR2) if results are obtained using Dictionary: Financial Stability (Correa et al.[2017])
                    % and so on...
