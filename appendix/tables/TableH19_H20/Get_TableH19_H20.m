%%% This file estimates the results reported in Tables H19 and H20
...
load Weights                                 % Sample period: 1982.01 - 2021.06
...
load TextVar             % Sample period: 1982.01 - 2021.06

% Coulmn 1: Sentiment Count
% Coulmn 2: Uncertainty Count
% Coulmn 3: Boolean Count
...
% Column 8: Sentiment TFM
% Column 9: Uncertainty TFM
% Column 10: Sentiment TF-IDF
% Column 11: Uncertainty TF-IDF
...
for indicator = 1:14
    ...
    % Select the indicator from TextVar (exclude the first row)
    Text = TextVar(2:end, indicator);
    Text = Text .* Weights .* 100;
    ...
    % ------------------| SAVE RESULTS |---------------------
    modname = sprintf('5SVBVAR%d', indicator);
    save(sprintf('%s.mat', modname), 'msfe', 'nfore', 'nmodel', 'Text');
