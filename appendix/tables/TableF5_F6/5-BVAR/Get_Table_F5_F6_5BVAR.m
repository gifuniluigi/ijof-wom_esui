%%% This file estimates the results reported in Tables F5 & F6, 5-BVAR
clear; 
clc;
...
clear y_fore;
modname = '5BVAR1'; % add 1 (e.g., 5SVBVAR1) if results are obtained using Scount;
                    % add 2 (e.g., 4SVBVAR2) if results are obtained using Dictionary: Financial Stability (Correa et al.[2017])
                    % and so on...
