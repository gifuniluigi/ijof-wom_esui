...
# The computations of the AUROC and its standard error make use of formulas given in
# M. Greiner, D. Pfeiffer, R.D. Smith (2000). Principles and practical application of the receiver-operating characteristic analysis for diagnostic tests. Preventive Veterinary Medicine 45 (2000) 23-41 (Appendix C).

# In the paper by Greiner et al., further references are given.
