%%% This file estimates the results reported in Table 5, Oil Price Uncertainty (OPU)
...
% Load Oil Price Uncertainty index of Abiad and Qureshi (2023)
load OPU              % Sample period: 1982.2 - 2021.6
Uncertainty = OPU(2:end,1);
