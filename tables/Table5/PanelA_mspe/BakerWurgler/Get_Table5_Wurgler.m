%%% This file estimates the results reported in Table 5, Baker and Wurgler (BW)
...
% Load Oil Price Uncertainty index of Baker and Wurgler (2006)
load BakerWurgler              % Sample period: 1982.2 - 2021.6
Sentiment = BakerWurgler(2:end,1);
...
for irep = t0:t-1
    ...
    Y = YY(1:irep,:); 
    yrp = rp(1:irep,:); 
    X = normalize(Sentiment(1:irep,1));
